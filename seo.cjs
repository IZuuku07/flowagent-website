...
function apply(html,data,path){
 ...
 if(info.service)graph.push({'@type':'Service',name:info.service.title,description:info.service.description,serviceType:info.service.title,url:info.url,provider:{'@id':org['@id']}});
